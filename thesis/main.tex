...
% topology without dedicated learned parameters. the model wont crash
...
%brief paragraph for each how the logging is done and how validation module
%compares the results via expected outcomes
